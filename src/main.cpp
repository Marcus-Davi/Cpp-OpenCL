...
int main(int argc, char **argv)
{
        ...
        int *B = (int *)malloc(sizeof(int) * NElements);
        ...
        ret = clEnqueueWriteBuffer(command_queue, a_mem_obj, CL_TRUE, 0,
                                   NElements * sizeof(int), A, 0, NULL, NULL);
        ret = clEnqueueWriteBuffer(command_queue, b_mem_obj, CL_TRUE, 0,
                                   NElements * sizeof(int), B, 0, NULL, NULL);
        ...
        int *C = (int *)malloc(sizeof(int) * NElements);
        ret = clEnqueueReadBuffer(command_queue, c_mem_obj, CL_TRUE, 0,
                                  NElements * sizeof(int), C, 0, NULL, NULL);

        // CPU
        int *C_cpu = (int *)malloc(sizeof(int) * NElements);
        start = std::chrono::high_resolution_clock::now();
        for (int i = 0; i < NElements; ++i)
        {
                C_cpu[i] = A[i] + B[i];
